...
class Generator:
    ...
    def generate(
        ...
        stop_sequences: List[str] = ["<|im_start|>", "<|im_end|>"],
...
class Agent:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.kwargs = {
            "stop_sequences": ["<|im_end|>", "</execute>", "<|im_start|>"],
            "do_sample": False,
            "max_new_tokens": 512,
            **kwargs,
        }
...
parser.add_argument("--model-name", type=str, required=True, default="xingyaoww/CodeActAgent-Mistral-7b-v0.1")
parser.add_argument("--openai-base-url", type=str, required=True, default="http://localhost:8080/v1")
parser.add_argument("--jupyter-kernel-url", type=str, required=True, default="http://localhost:8081/execute")
